  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url(); ?>">
     <!-- <div class="sidebar-brand-icon">
        <img src="<?php echo base_url('uploads/system_logo/logow.png'); ?>">
      </div>-->
      <div class="sidebar-brand-text mx-3">TelezecareMD </sup></div>
    </a>
    <!-- Divider -->
    ...
    <li class="nav-item <?php if($active_menu==22) {echo "active"; } ?>"><a class="nav-link" href="<?php echo base_url().'admin/newsletters'?>"><i class="fas fa-fw fa-users"></i><span>Newsletter</span></a></li>
    
    <li class="nav-item <?php if($active_menu==21) {echo "active"; } ?>"><a class="nav-link" href="<?php echo base_url().'admin/corporate_user'?>"><i class="fas fa-fw fa-users"></i><span>Corporate Users</span></a></li>
