                            ...
                            <td>
                                <div class="dropdown no-arrow mb-4">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <?php
                                        if($user['admin_verifcation']!=''){
                                            ?>
                                         <a class="dropdown-item" href="<?php echo base_url() . 'admin/status_change/'. $user['user_id'];?>" title="Status"><?php 
                                         if($user['admin_verifcation']=='disapproved'){
                                         echo 'approved';
                                         }
                                         else{
                                         echo 'disapproved';
