                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr id='row_<?php echo $user['user_id'];?>'>
                            ...
                            <td>
                                <div class="dropdown no-arrow mb-4">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item" href="<?php echo base_url() . 'admin/cstatus_change/'. $user['user_id'];?>" title="Accept" class="delete">Accept</a>
                                        
                                        <a class="dropdown-item" href="<?php echo base_url() . 'admin/cstatus_change1/'. $user['user_id'];?>" title="Remove" class="delete">Remove</a>
                            ...
                            <td><?php echo ($user['admin_verifcation'] == 'corporate_disapproved') ? 'Remove' : 'Accept';?></td>
                        </tr>
                        <?php endforeach;?>
                    </tbody>
                </table>
