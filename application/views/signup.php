...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url('uploads/system_logo/logow.png'); ?>">
  ...
  <title><?php echo get_app_config("app_name") ?> - Signup</title>
                ...
                <div class="p-5">
                  <div class="text-center">
                    <a href="<?php echo base_url(); ?>">
                      <img src="<?php echo base_url('uploads/system_logo/logow.png'); ?>" style="height:100px;"></a><br>
                  ...
                  <form class="user" action="<?php echo base_url('signup/do_signup'); ?>" method="post">
                    <div class="form-group">
                      <input type="text" name="name" class="form-control form-control-user" id="name" aria-describedby="name" placeholder="Enter Name..." required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <input type="password" name="password2" class="form-control form-control-user" id="exampleInputPassword" placeholder="Confirm Password" required>
                    </div>
