...
class Email_model extends CI_Model {
	...
	function account_opening_email($email = '', $password='', $uid='')
	{	
	/*	$app_name			=	get_app_config("app_name");
		$admin_email		=	get_app_config("contact_email");
		$system_name		=	get_app_config("app_name");
		...
		$to = $email;
         ...
         $message = "<a href='https://telezecaremd.com/verifyemail.php?typ=verify&id=$uid'>https://telezecaremd.com/verifyemail.php?typ=verify&id=$uid</a>";
        
         $header = "From:info@telezecaremd.com \r\n";
	...
	/*	//var_dump($email,$token);
		...
		$to = $email;
         $subject = "Password recovery - TelezecareMD";
         
         $message = "Your New Login Password : ".$password;
    ...
    'smtp_port' => 465,
    'smtp_user' => 'info@telezecaremd.com',
    'smtp_pass' => 'Q5*i~W5^Ws)_',
    'charset'=>'utf-8',
    'wordwrap'=> TRUE,
    'mailtype' => 'html'
);
...
// Set to, from, message, etc.
 ...
 if($sub == NULL || $sub ==''){
	...
	$this->email->from('info@telezecaremd.com', 'TelezecareMD');
		$this->email->to($to);
		if($replay_to != NULL)
