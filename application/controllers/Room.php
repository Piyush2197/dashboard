...
class Room extends CI_Controller{
    ...
    function join_meeting($meeting_code=''){
		...
		$data['nick_name'] 			=	""; 
		$data['user_id'] 			=	$this->session->userdata("user_id") ? $this->session->userdata("user_id") : $this->input->post("user_id"); 
    ...
    function create_and_join_by_post_meeting_code(){
    	$user_id                  =   $this->session->userdata("user_id") ? $this->session->userdata("user_id") : $this->input->post('user_id');
        $meeting_code             =   $this->input->post('meeting_code');        
